...
export interface ContentBlock {
  id: string;
  type: 'heading' | 'text' | 'image' | 'gif' | 'video' | 'divider' | 'grid' | 'accordion' | 'button' | 'html';
  content?: string;
  url?: string;
  alt?: string;
...
export const getMockSimpleCourse = (id: string): SimpleCourse => ({
  ...
  description: '초보자부터 전문가까지, 체계적인 커리큘럼으로 유튜브 쇼츠 크리에이터가 되는 완벽한 과정입니다.',
  price: 99000,
  ...
  content_blocks: [
    ...
    },
    {
      id: 'text-1',
      type: 'text',
      content: '유튜브 쇼츠를 시작하고 싶지만 어떻게 해야 할지 막막한 분들, 이미 시작했지만 조회수가 늘지 않아 고민인 분들, 체계적인 커리큘럼으로 제대로 배우고 싶은 분들을 위한 과정입니다.'
    },
    {
      id: 'img-2',
      type: 'image',
    ...
    },
    {
      id: 'text-2',
      type: 'text',
      content: '유튜브 쇼츠의 알고리즘 이해부터 시작하여, 바이럴 콘텐츠 기획법, 촬영 및 편집 기술, 썸네일 제작, 업로드 최적화, 데이터 분석까지 A to Z를 다룹니다.'
    },
    {
      id: 'video-1',
      type: 'video',
  ...
  faqs: [
    {
      ...
      answer: '한 번 구매하시면 평생 시청 가능합니다. 업데이트되는 콘텐츠도 추가 비용 없이 이용하실 수 있습니다.'
    },
    {
      id: 'faq-2',
      question: '환불은 가능한가요?',
