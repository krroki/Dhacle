...
import { getDisplayNickname, getNicknameType, isValidNaverCafeUrl, DINOHIGHCLASS_CAFE } from '@/lib/utils/nickname-generator';
    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({
          ...
          naver_cafe_member_url: cafeMemberUrl,
        ...
        <TabsContent value="nickname" className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                {profile.random_nickname && (
                  <Alert>
                    ...
                    <AlertDescription>
                      랜덤 닉네임은 변경할 수 없습니다. 네이버 카페 연동 시 카페 닉네임이 우선 표시됩니다.
                    </AlertDescription>
                  </Alert>
                )}
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                &apos;{DINOHIGHCLASS_CAFE.name}&apos; 카페 회원 인증 시 카페 닉네임을 사용할 수 있습니다
              </CardDescription>
            </CardHeader>
            <CardContent>
              {profile.naver_cafe_verified ? (
                  ...
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium">{profile.naver_cafe_nickname}</span>
                      </div>
                      <div className="flex items-center justify-between">
                      ...
                      {profile.naver_cafe_member_url && (
                        <div className="pt-2">
                          <a 
                            href={profile.naver_cafe_member_url}
                            target="_blank"
                ...
                <div className="space-y-4">
                  <Alert>
                    <Info className="h-4 w-4" />
                    <AlertDescription>
                      <strong>{DINOHIGHCLASS_CAFE.name}</strong> 카페 회원만 연동 가능합니다.<br/>
                      카페 가입 후 닉네임과 프로필 URL을 입력해주세요.<br/>
                      <a 
