    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <Card className="border-2 border-dashed">
        <CardHeader className="text-center pb-8">
          ...
          <CardTitle className="text-3xl mb-2">Q&A</CardTitle>
          <p className="text-muted-foreground text-lg">질문과 답변을 나누는 공간</p>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900 rounded-lg p-6 text-center">
            ...
            <p className="text-muted-foreground">
              YouTube Shorts 제작에 대한 모든 질문과 답변을 나눌 수 있는 Q&A 게시판을 준비하고
              있습니다.
            </p>
          </div>
        </CardContent>
