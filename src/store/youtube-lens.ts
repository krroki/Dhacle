  ...
  devtools(
    persist(
      (set, get) => ({
        ...
        // 즐겨찾기 관련 액션
        addFavorite: (video, tags = [], notes = '') => set((state) => {
        ...
        updateFavorite: (videoId, updates) => set((state) => {
          const newFavorites = new Map(state.favoriteVideos);
        ...
        updateQuotaUsage: (units) => set((state) => {
